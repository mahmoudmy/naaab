<template>
	<div class="app">
		...
		<nav class="pagination">
			<router-link :to="prevPageLink" class="button is-outlined page-btn" v-if="page > 1">صفحه قبل</router-link>
			<router-link :to="nextPageLink" class="button is-outlined page-btn" v-if="abyatArray.length === 20">صفحه بعد</router-link>
		</nav>
	</div>
</template>
...
<style>
	...
	.button.page-btn, .button.page-btn:active, .button.page-btn:focus {
		border-color: #adb5bd;
	}
